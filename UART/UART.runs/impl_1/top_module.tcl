namespace eval ::optrace {
  variable script "C:/FPGA/UART/UART.runs/impl_1/top_module.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/FPGA/UART/UART.cache/wt [current_project]
  set_property parent.project_path C:/FPGA/UART/UART.xpr [current_project]
  set_property ip_output_repo C:/FPGA/UART/UART.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/FPGA/UART/UART.runs/synth_1/top_module.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/FPGA/UART/UART.srcs/constrs_1/new/UART.xdc
